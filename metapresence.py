...
parser.add_argument("all_sequences_fasta",help="the fasta file on which the reads are aligned. If <contigs_genome> is a folder, this file is not needed, but a value has to be put anyway.")
